...
import com.github.rochedo098.droids.screens.machines.basic.CrusherScreen
    ...
    class CrusherBlock(settings: Settings): MachineBase.MachineBlock(settings) {
        ...
        override fun <T : BlockEntity?> getTicker(
            ...
            return BlockEntityTicker { world, pos, state, blockEntity ->
                CrusherBlockEntity.tick(world, pos, state, blockEntity as? CrusherBlockEntity ?: return@BlockEntityTicker)
            }
        }
    }
