...
object NeuralConnectorScreen {
    class NeuralConnectorScreen(handler: ScreenHandler, inventory: PlayerInventory, title: Text): MachineScreen.MachineScreen(handler, inventory, title) {
        override fun getBackgroundTexture(): Identifier = Identifier("minecraft", "textures/gui/container/furnace.png")

    }

    class NeuralConnectorScreenHandler(syncId: Int, playerInventory: PlayerInventory): MachineScreen.MachineScreenHandler(TODO("ADD THIS LATER"), syncId) {
        init {
